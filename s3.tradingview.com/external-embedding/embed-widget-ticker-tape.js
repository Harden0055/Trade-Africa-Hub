    ...
    function i(r) {
        ...
        new class extends class {
            ...
            _replaceScript(i) {
                ...
                g && C.setAttribute("nonce", g), this.iframeContainer.appendChild(C);
                const T = this.hasCopyright() ? "calc(100% - 32px)" : "100%",
                    _ = location.hostname,
                ...
                this.iframe = this._createIframe(T, c, a, E, I), this._addCSPErrorListener(c), g && this.iframe.setAttribute("nonce", g);
                const x = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (x ? ((0, t.ensureNotNull)(x.parentElement).replaceChild(this.iframe, x), null == s || s.remove()) : f ? (this.iframeContainer.appendChild(this.iframe), null == s || s.remove()) : (this.iframeContainer.appendChild(this.iframe), h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function(t, e, i) {
            ...
            filterRawSettings(t) {
                ...
                try {
                    ...
                    e.height = function(t, e, i, r) {
                        let s = (n = t === m.Adaptive && r ? r <= w : t === m.Compact, n ? 72 : 44);
                        var n;
                        return e || (s += 2), i && (s += 32), s
                    }(t.displayMode, t.isTransparent, this.hasCopyright(), i)
                }
                return e
            }
            get propertiesToWorkWith() {
                return ["symbols", "locale", "showSymbolLogo", "colorTheme", "isTransparent", "largeChartUrl", "displayMode", "customer"]
            }
        }
    })()
})();