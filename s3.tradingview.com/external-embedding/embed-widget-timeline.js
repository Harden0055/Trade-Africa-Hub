        ...
        new class extends class {
            ...
            _replaceScript(r) {
                ...
                this.iframeContainer = h && f ? h : document.createElement("div"),
                    o && (this.settings = this.filterRawSettings(o)), o && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"), this.settings = this.filterRawSettings(this.defaultSettings));
                const w = "32px",
                    {
                        width: y,
                        height: b
                ...
                if (P ? ((0, t.ensureNotNull)(P.parentElement).replaceChild(this.iframe, P), null == s || s.remove()) : f ? (this.iframeContainer.appendChild(this.iframe), null == s || s.remove()) : (this.iframeContainer.appendChild(this.iframe), h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function(t, e, r) {
            ...
            _validateSettings() {
                ...
                return null !== e && null !== r && (this.settings.width = e, this.settings.height = r, !0)
            }
            ...
            _setHashString(t, e) {
                const r = {};
                e && (r.frameElementId = e), Object.keys(this.settings).forEach((t => {
            ...
            _createIframe(t, e, r, i, s) {
                ...
                r && (n.id = r), this.settings.enableScrolling || n.setAttribute("scrolling", "no"), n.setAttribute("allowtransparency", "true"), n.setAttribute("frameborder", "0"), n.style.userSelect = "none", n.style.boxSizing = "border-box", n.style.display = "block", n.style.height = t, n.style.width = "100%";
                const o = new URL(this._iframeSrcBase(e));
                return this._setSettingsQueryString(o), this._setHashString(o, r), n.setAttribute("src", o.toString()), n.title = i, n.lang = s, n
            }
            ...
            _updateCopyrightHrefParams(t, e, r) {
                if (this._copyrightContainer) {
                    ...
                    if (i) {
                        ...
                        if (s) try {
                            const n = new URL(s);
                            n.searchParams.set("utm_source", t), n.searchParams.set("utm_medium", e), n.searchParams.set("utm_campaign", r), i.setAttribute("href", n.toString())
                        } catch (t) {
            ...
            useQueryStringParameters(t) {
                return t && t.feedMode === m.Symbol ? function(t) {
                    try {
            ...
            get propertiesToWorkWith() {
                return ["width", "height", "market", "symbol", "colorTheme", "isTransparent", "colorTheme", "displayMode", "largeChartUrl"]
            }
        }
    })()
})();